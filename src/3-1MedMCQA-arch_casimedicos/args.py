...
class Arguments:
    ...
    wandb_project_name:str = "tfg-baseline-Paula"           # Wandb project name

    # Paths
    dataset_folder:str = "../../data/casiMedicos/JSONL"     # Dataset folder
    models_folder:str = "/home/shared/esperimentuak/AingeruTFG/TFG/models/MedMCQA-arch_casimedicos"
