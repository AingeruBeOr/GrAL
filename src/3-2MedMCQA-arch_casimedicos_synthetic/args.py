...
class Arguments:
    ...
    wandb_project_name:str = "tfg-baseline-Paula-synthetic" # Wandb project name

    # Paths
    dataset_folder:str = "../../data/casiMedicos-balanced/JSONL"     # Dataset folder
    models_folder:str = "/home/shared/esperimentuak/AingeruTFG/TFG/models/MedMCQA-arch_casimedicos_synthetic"
    pretrained_model:str = "/home/shared/esperimentuak/AingeruTFG/TFG/models/eriberta_libre"
    ...
    learning_rate:float = 5.00e-5                           # Learning rate
