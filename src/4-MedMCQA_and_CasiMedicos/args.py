...
class Arguments:
    ...
    num_epochs:int = 1                                      # EPOCHS
    batch_size:int = 3                                      # Batch size
    accumulate_grad_batches:int = 200                       # Gradient accumulation
    learning_rate:float = 5e-5                              # Learning rate
    val_check_interval:int = 1000                           # Validation check interval (how many batches to consider before running validation)
